        ...
        >
          ...
          >
            ...
            <Image
              ...
              alt={actualTitle}
              fill
              sizes='(max-width: 640px) 33vw, (max-width: 1024px) 22vw, 176px'
          ...
          >
            ...
            >
              ...
              {/* 自定义 tooltip */}
              <div
                className='absolute z-50 bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-1 bg-gray-800 text-white text-xs rounded-md shadow-lg opacity-0 invisible peer-hover:opacity-100 peer-hover:visible transition-all duration-200 ease-out delay-100 whitespace-nowrap pointer-events-none'
                style={
                  {
                    WebkitUserSelect: 'none',
                    userSelect: 'none',
